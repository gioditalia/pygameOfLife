    ...
    def on_render(self):
        ...
        for col in self.col_pos:
            pygame.draw.line(self.__display,self.__grid_color,(col,0),
                             (col,self.__size[1]))
        #draw info
        self.__display.blit(self.__font_info.render("Generation: "+str(self.__gen_counter), True,(0,255,0)),(100,15))
        self.__display.blit(self.__font_info.render("T(period): "+str(self.__gen_sleep), True,(0,255,0)),(300,15))
        self.__display.blit(self.__font_info.render("Start/Stop : s", True,(0,255,255)),(500,15))
        self.__display.blit(self.__font_info.render("Clear : c", True,(0,255,255)),(500,35))
        self.__display.blit(self.__font_info.render("Reduce/Increase T:  -/+", True,(0,255,255)),(500,55))
